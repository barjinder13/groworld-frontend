        ...
        <>
            ...
            <div className="login">
                <div className="container">
                                ...
                                <h2>Update Sub Category</h2><br/>

                                <div className="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                                    
                                <select name="cat" className="form-control" value={subcatinfo.catid} onChange={(e)=>setcat(e.target.value)}>
                                ...
                                <input type="text" name="scatname" value={subcat} onChange={(e) => setsubcat(e.target.value)} placeholder="Sub Category Name" required=" " /><br/>
