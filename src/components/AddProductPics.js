...
if(subcat!=="")
{
        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (result.statuscode === 1) {
                    ...
                    toast.error("No Product Avaliable");
                }
                else {
                    toast.error("Error Occured");
                }
        ...
        try {
            ...
            if (resp.ok) {
                ...
                if (result.statuscode === 1) {
                    ...
                    toast.error("No Sub Categories Avaliable");
                }
                else {
                    toast.error("Error Occured");
                }
    ...
    return (
		...
		<div className="breadcrumbs">
                <div className="container">
                    <ol className="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                        ...
                        <li className="active">Add Product Pics</li>
                    </ol>
                </div>
            </div>
                <div className="login">
        ...
        <div className="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
